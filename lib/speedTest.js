...
// This is the URL we are going to go and resquest to & our API key
var wpt = new WebPageTest( config.testServer, config.apiKey );
...
function requestData( sites ) {
	...
	for ( var key in sites ) {
		( function( key ) {
			...
			promise_chain = promise_chain.then( promiseLink );
